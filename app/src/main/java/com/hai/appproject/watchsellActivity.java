...
public class watchsellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watchsell);
        ...
        reff= FirebaseDatabase.getInstance().getReference().child("WatchDetails");
        FOLDER= FirebaseStorage.getInstance().getReference().child("Watches");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Imagename.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Toast.makeText(watchsellActivity.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.logout)
        {
            ...
            Intent n=new Intent(watchsellActivity.this,MainActivity.class);
            startActivity(n);
            finish();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==IMAGEBACK){
            if(resultCode==RESULT_OK && data.getData()!=null){
                Toast.makeText(watchsellActivity.this,"Uploading",Toast.LENGTH_SHORT).show();
