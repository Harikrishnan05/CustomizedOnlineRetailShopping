...
public class clothsellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothsell);
        ...
        reff= FirebaseDatabase.getInstance().getReference().child("ClothDetails");
        FOLDER= FirebaseStorage.getInstance().getReference().child("Clothes");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Imagename.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Toast.makeText(clothsellActivity.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.logout)
        {
            ...
            Intent n=new Intent(clothsellActivity.this,MainActivity.class);
            startActivity(n);
            finish();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==IMAGEBACK){
            if(resultCode==RESULT_OK && data.getData()!=null){
                Toast.makeText(clothsellActivity.this,"Uploading",Toast.LENGTH_SHORT).show();
